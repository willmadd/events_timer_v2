...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Events Countdown | The intro video creator for professional web and in person events</title>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-0J26H056Y7"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-0J26H056Y7');
</script>
    </head>
    <body>
    <div id="events"></div>
