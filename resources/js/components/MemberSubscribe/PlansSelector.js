...
const PlansSelector = ({ plans, setSelectedPlan, selectedPlan }) => {
    return (
        <div className="plans__area">
            <p>{`If you're running online or in person events regularly then it works out much more cost effective to purchase an Events Countdown subscription. The first month is on us, so if you don't like our service, you can cancel within the first month and you won't be charged at all.`}</p>
